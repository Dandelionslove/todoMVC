...
!function (t, e) {
    ...
    var e = function () {
        ...
        function M(t) {
            return z(t) && !Z(t) && Object.getPrototypeOf(t) == Object.prototype
        }

        function V(t) {
            var e = !!t && "length" in t && t.length, n = i.type(t);
            return "function" != n && !Z(t) && ("array" == n || 0 === e || "number" == typeof e && e > 0 && e - 1 in t)
        }
        ...
        function I(t, e) {
            return "number" != typeof e || h[F(t)] ? e : e + "px"
        }
        ...
        function H(t) {
            return "children" in t ? a.call(t.children) : i.map(t.childNodes, function (t) {
        ...
        function Y(t, i, r) {
            for (n in i) r && (M(i[n]) || $(i[n])) ? (M(i[n]) && !M(t[n]) && (t[n] = {}), $(i[n]) && !$(t[n]) && (t[n] = []), Y(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n])
        }
        ...
        var e, n, i, r, P, T, o = [], s = o.concat, u = o.filter, a = o.slice, f = t.document, c = {}, l = {},
            ...
            E = ["after", "prepend", "before", "append"], b = f.createElement("table"), w = f.createElement("tr"),
            x = {tr: f.createElement("tbody"), tbody: b, thead: b, tfoot: b, td: w, th: w, "*": f.createElement("div")},
            N = /^[\w-]*$/, C = {}, O = C.toString, S = {}, A = f.createElement("div"), L = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
        ...
        return S.matches = function (t, e) {
            ...
            var o, s, u;
            return d.test(t) && (o = i(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in x || (n = "*"), u = x[n], u.innerHTML = "" + t, o = i.each(a.call(u.childNodes), function () {
                u.removeChild(this)
            })), M(r) && (s = i(o), i.each(r, function (t, e) {
            ...
            var r;
            if (!t) return S.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && p.test(t)) r = S.fragment(t, RegExp.$1, n), t = null; else {
                if (n !== e) return i(n).find(t);
                r = S.qsa(f, t)
            } else {
                if (j(t)) return i(f).ready(t);
                if (S.isZ(t)) return t;
                if ($(t)) r = _(t); else if (z(t)) r = [t], t = null; else if (p.test(t)) r = S.fragment(t.trim(), RegExp.$1, n), t = null; else {
                    if (n !== e) return i(n).find(t);
                    r = S.qsa(f, t)
                }
            }
            ...
            var n, i = "#" == e[0], r = !i && "." == e[0], o = i || r ? e.slice(1) : e, s = N.test(o);
            ...
            return !1
        }, i.type = D, i.isFunction = j, i.isWindow = Z, i.isArray = $, i.isPlainObject = M, i.isEmptyObject = function (t) {
            var e;
            for (e in t) return !1;
            return !0
            ...
            var n, r, o, i = [];
            if (V(t)) for (r = 0; r < t.length; r++) n = e(t[r], r), null != n && i.push(n); else for (o in t) n = e(t[o], o), null != n && i.push(n);
            return B(i)
        }, i.each = function (t, e) {
            var n, i;
            if (V(t)) {
            ...
            not: function (t) {
                ...
                if (j(t) && t.call !== e) this.each(function (e) {
                    ...
                    var r = "string" == typeof t ? this.filter(t) : V(t) && j(t.item) ? a.call(t) : i(t);
            ...
            has: function (t) {
                return this.filter(function () {
                    return z(t) ? i.contains(this, t) : i(this).find(t).size()
                })
            },
            eq: function (t) {
            ...
            closest: function (t, e) {
                ...
                return this.each(function (i, o) {
                    for (; o && !(r ? r.indexOf(o) >= 0 : S.matches(o, t));) o = o !== e && !k(o) && o.parentNode;
            ...
            html: function (t) {
                return 0 in arguments ? this.each(function (e) {
                    ...
                    i(this).empty().append(U(this, t, e, n))
            ...
            attr: function (t, i) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function (e) {
                    if (1 === this.nodeType) if (z(t)) for (n in t) W(this, n, t[n]); else W(this, t, U(this, i, e, this.getAttribute(t)))
            ...
            prop: function (t, e) {
                return t = L[t] || t, "string" != typeof t || 1 in arguments ? this.each(function (i) {
                    if (z(t)) for (n in t) this[L[n] || n] = t[n]; else this[t] = U(this, e, i, this[t])
                }) : this[0] && this[0][t]
            },
            ...
            offset: function (e) {
                if (e) return this.each(function (t) {
                    var n = i(this), r = U(this, e, t, n.offset()), o = n.offsetParent().offset(),
                ...
                if (arguments.length < 2) {
                    ...
                    if ($(t)) {
                        ...
                        return i.each(t, function (t, e) {
                            o[e] = r.style[P(e)] || s.getPropertyValue(e)
                        }), o
                    }
                }
                var u = "";
                if ("string" == D(t)) e || 0 === e ? u = F(t) + ":" + I(t, e) : this.each(function () {
                    this.style.removeProperty(F(t))
                }); else for (n in t) t[n] || 0 === t[n] ? u += F(n) + ":" + I(n, t[n]) + ";" : this.each(function () {
            ...
            removeClass: function (t) {
                return this.each(function (n) {
                    if ("className" in this) {
                        ...
                        r = G(this), U(this, t, n, r).split(/\s+/g).forEach(function (t) {
                            r = r.replace(q(t), " ")
                        }), G(this, r.trim())
                    }
                })
            ...
            toggleClass: function (t, n) {
                return t ? this.each(function (r) {
                    var o = i(this), s = U(this, t, r, G(this));
            ...
            i.fn[t] = function (r) {
                var o, s = this[0];
                return r === e ? Z(s) ? s["inner" + n] : k(s) ? s.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function (e) {
                    s = i(this), s.css(t, U(this, r, e, s[t]()))
                })
            }
        }), E.forEach(function (n, r) {
            var o = r % 2;
            i.fn[n] = function () {
                var n, u, s = i.map(arguments, function (t) {
                    var r = [];
                ...
                return s.length < 1 ? this : this.each(function (e, n) {
                    ...
                    var c = i.contains(f.documentElement, u);
                    s.forEach(function (e) {
                        if (a) e = e.cloneNode(!0); else if (!u) return i(e).remove();
        ...
        }), S.Z.prototype = X.prototype = i.fn, S.uniq = T, S.deserializeValue = K, i.zepto = S, i
    }();
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
        ...
        function y(t, n, r, o, s, a, f) {
            var c = h(t), p = u[c] || (u[c] = []);
            n.split(/\s/).forEach(function (n) {
                if ("ready" == n) return e(document).ready(r);
                var u = d(n);
                u.fn = r, u.sel = s, u.e in l && (r = function (t) {
                ...
                }, u.i = p.length, p.push(u), "addEventListener" in t && t.addEventListener(v(u.e), u.proxy, g(u, f))
            })
        }
        ...
        var i, n = 1, r = Array.prototype.slice, o = e.isFunction, s = function (t) {
            ...
            }, u = {}, a = {}, f = "onfocusin" in t, c = {focus: "focusin", blur: "focusout"},
        ...
        var b = function () {
            ...
            return !1
        }, x = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/, N = {
        ...
        e.fn.delegate = function (t, e, n) {
            ...
            return t && !s(t) ? (e.each(t, function (t, e) {
                h.on(t, n, u, e, f)
            }), h) : (s(n) || o(a) || a === !1 || (a = u, u = n, n = i), (a === i || u === !1) && (a = u, u = i), a === !1 && (a = w), h.each(function (i, o) {
                f && (c = function (t) {
                    return E(o, t.type, a), a.apply(this, arguments)
                }), n && (l = function (t) {
                    var i, s = e(t.target).closest(n, o).get(0);
                    return s && s !== o ? (i = e.extend(O(t), {
                        currentTarget: s,
                        liveFired: o
                    }), (c || a).apply(s, [i].concat(r.call(arguments, 1)))) : void 0
                }), y(o, t, a, u, n, l || c)
            }))
        ...
        function u(n, o, s) {
            var u = n[r] || (n[r] = ++t.uuid), f = e[u] || (e[u] = a(n));
